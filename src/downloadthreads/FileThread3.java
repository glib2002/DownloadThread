 ...
 * @author Глеб
 */
public class FileThread3 implements Runnable{
    ...
    public void download() throws IOException {
        ...
        while (true) {
            ...
            for (int x = 0; x < 12; x++) {
                URL url = new URL(urls[x]);

                String nameFile = "File" + x;
                String extension = ".mp3";
                System.out.println("Now downloading " + nameFile + " ...");
                String fullNameFile = nameFile + extension;
                fileDownload = new File("c:\\Users\\Глеб\\Documents\\NetBeansProjects\\DownloadThreads\\src\\Downloads3\\" + fullNameFile);
